						...
						<div class="row">
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h3>Untuk Menikmati liburan terbaik anda..</h3>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>Silahkan daftar untuk menikmati liburan anda</p>
					</div>
				</div>
				<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<p>Perusahaan kami bergerak di bidang penyewaan jasa tour and travel. kami melayani untuk melakukan tour di wilayah Malang raya.</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Jln Candi Singosari No.72 Malang</li>
								<li><i class="icon-phone2"></i>+628111222333</li>
								<li><i class="icon-mail"></i><a href="#">ngalamtour@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.ngalamtour.com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
